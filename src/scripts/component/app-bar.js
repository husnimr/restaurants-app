class AppBar extends HTMLElement {
  ...
  render() {
    ...
    <nav id="nav" class="menu">
      <h1>
        <a href="./" title="Navbar Brand">Indonesian Resto</a>
      </h1>
      ...
      <ul class="menu-list">
          ...
          <li><a href="https://linkedin.com/in/husnimubarokramadhan" title="Link ke about us" target="_blank" rel="noreferrer">About
                  Us</a></li>
      </ul>
    </nav>
    `;
